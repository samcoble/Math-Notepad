...
LatexCmds.ss = bind(VanillaSymbol,'\\ss ','&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;');

LatexCmds.cross = bind(VanillaSymbol, '\\cross ', '&times;');

// LatexCmds.eval = bind(VanillaSymbol,'<big class="mq-vert-bar">]</big>');
LatexCmds.bint = bind(VanillaSymbol, '\\bint ', '<big>&int;</big>');
LatexCmds.bsum = bind(VanillaSymbol, '\\bsum ', '<big>&sum;</big>');
...
LatexCmds.lam = bind(NonSymbolaSymbol,'\\lambda ','&lambda;');
...
var LimitNotation = P(MathCommand, function(_, super_) {
  ...
  _.createLeftOf = function(cursor) {
    ...
    // Letter('&rarr;').createLeftOf(cursor);
...
LatexCmds.lim = bind(LimitNotation,'\\lim ','lim');
...
LatexCmds['\u222B'] =
LatexCmds.int =
LatexCmds.integral = bind(SummationNotation,'\\int ','&#x222B;');
